...
//     const {hall, branch, organization} = req.body;

//  try{

//     const hall = await Hall.create({hall, branch, organization})

//     res.status(200).json({
//         success: true,
//         message: "hall controller called",
//         data: hall
//     })
//  }catch(err){
//     res.status(400).json({
...
//     const { halls, branch, organization } = req.body;
  
//     try {
//       if (!Array.isArray(halls) || halls.length === 0) {
//         return res.status(400).json({
//           success: false,
//           message: "Invalid or empty halls data",
//         });
//       }
  
//       const newHall = await Hall.create({ halls, branch, organization });
...
//       });
//     } catch (err) {
//       console.error("Error creating halls:", err);
//       res.status(400).json({
//         success: false,
//         message: "Error creating halls",
//         data: err.message,
//       });
//     }
//   };
